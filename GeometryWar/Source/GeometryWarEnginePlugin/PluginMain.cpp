...
#include "GeometryWarEnginePluginPCH.h"
...
//============================================================================================================
class GeometryWarEnginePlugin : public IVisPlugin_cl
{
public:
  ...
  {
    return "GeometryWarEnginePlugin";  // must match DLL name
  }
};

//  global plugin instance
GeometryWarEnginePlugin g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_GeometryWarEnginePlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_GeometryWarEnginePlugin();}
...
void GeometryWarEnginePlugin::OnInitEnginePlugin()
{
  hkvLog::Info("GeometryWarEnginePlugin:OnInitEnginePlugin()");
...
void GeometryWarEnginePlugin::OnDeInitEnginePlugin()
{
  hkvLog::Info("GeometryWarEnginePlugin:OnDeInitEnginePlugin()");
